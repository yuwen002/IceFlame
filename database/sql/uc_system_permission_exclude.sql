...
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '权限排除，公共模块，任何管理员都可以访问' ROW_FORMAT = Dynamic;
...
INSERT INTO `uc_system_permission_exclude` VALUES (4, '管理员登入信息', 'manage.UcSystemMaster.GetSystemMasterInfo', 'manage/master/info', NULL, '2023-04-12 18:20:20', '2023-04-12 18:20:20');
